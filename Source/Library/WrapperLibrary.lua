...
function Wrapper.SetMethodEnvironment(Method, Object)
	...
	pcall(setfenv, Method, setmetatable({}, {
		__index = function(_, Key)
			return (Key == "this" and Object or FunctionEnv[Key])
		end;
	}))
end
...
-- Easy game service access (e.g. Svc["Workspace"] instead of game:GetService("Workspace"))
Wrapper.Svc = setmetatable({}, {__index = function(_, Key)
